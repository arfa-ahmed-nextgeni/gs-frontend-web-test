...
const CartDrawerSkeletonContent = () => (
  <>
    <CartDrawerHeader />
    ...
    <div className="bg-bg-default flex shrink-0 flex-row gap-2.5 p-5 lg:flex-col-reverse">
      <div className="h-12.5 border-border-base flex-1 rounded-xl border bg-transparent lg:block lg:flex-none lg:border-none rtl:flex rtl:items-center rtl:justify-center">
        <Skeleton className="ltr:translate-1/2 h-6 w-1/2" />
      </div>
      <div className="bg-btn-bg-primary h-12.5 flex-1 rounded-xl lg:block lg:flex-none rtl:flex rtl:items-center rtl:justify-center">
        <Skeleton className="ltr:translate-1/2 h-6 w-1/2" />
      </div>
    </div>
  </>
...
export const CartDrawerSkeleton = () => {
  ...
  return (
    ...
    >
      <DrawerContent
        animated={true}
        className="bg-bg-body lg:w-107.5! z-99 flex h-[69dvh] flex-col border-none lg:h-full"
      >
        <CartDrawerSkeletonContent />
      </DrawerContent>
    </Drawer>
  );
};
