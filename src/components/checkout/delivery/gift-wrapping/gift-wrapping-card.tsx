...
export const GiftWrappingCard = ({
  ...
  return (
    <button
      className={cn(
        "bg-bg-default transition-default focus-visible:ring-border-primary/20 focus-visible:ring-offset-bg-default flex shrink-0 flex-col items-center overflow-hidden rounded-[10px] border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
      ...
      type="button"
    >
      <div className="size-35 relative isolate shrink-0 overflow-hidden rounded-t-[10px]">
